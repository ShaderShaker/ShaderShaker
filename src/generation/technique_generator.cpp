...
{
    bool TechniqueGenerator::Generate( Base::ObjectRef< AST::TranslationUnit > &vertex_program,
    ...
    {
        std::vector< std::string > pixel_used_semantic_set;
        Generation::CodeGenerator code_generator;
        std::vector< std::string > interpolator_semantic_list;

        std::copy( m_InputSemanticTable.begin(),
            m_InputSemanticTable.end(),
            std::back_inserter( interpolator_semantic_list ) );

        std::copy( m_InterpolatorSemanticTable.begin(),
            m_InterpolatorSemanticTable.end(),
            std::back_inserter( interpolator_semantic_list ) );

        code_generator.GenerateShader( pixel_program,
        ...
        code_generator.GenerateShader( vertex_program,
