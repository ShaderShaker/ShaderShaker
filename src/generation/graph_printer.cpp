...
namespace Generation
{
    ...
    GraphPrinter::GraphPrinter( std::ostream &output_stream ) : m_OutputStream( output_stream )
    {
    }
    ...
    void GraphPrinter::Visit( const GraphNode &node )
    {
        ...
        {
            m_OutputStream << "node_" << &node << " [label=\"" << node.GetFunctionDefinition().GetName() << "\"];"
                           << std::endl;
        }
