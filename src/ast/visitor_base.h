...
namespace AST
{
    ...
    class VisitorBase
    {
      ...
      public:
        ...
        virtual void Visit(
            typename modifier::template m< struct VariableDeclaration >::type &variable_declaration ) = 0;
        ...
        virtual void Visit(
            typename modifier::template m< struct FunctionDeclaration >::type &function_declaration ) = 0;
