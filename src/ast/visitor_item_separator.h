...
namespace AST
{
    ...
    class VisitorItemSeparator
    {
      public:
        ...
        void operator()( VisitorBase< visitor_is_const > &visitor,
            const _Table_ & /*table*/,
            const typename _Table_::const_iterator &current_iterator )
        {
    ...
    {
      public:
        VisitorStreamArrayItemSeparator( std::ostream &stream,
            const std::string &separator = ",",
            const bool add_endl = false )
